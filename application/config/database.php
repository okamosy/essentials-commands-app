...
$db['development']['username'] = 'ess';
$db['development']['password'] = 'qwerty';
$db['development']['database'] = 'v2_ess';
...
$db['testing']['username'] = 'tester';
$db['testing']['password'] = 'test';
$db['testing']['database'] = 'ess_test';
